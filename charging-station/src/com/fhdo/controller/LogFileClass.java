	...
	public void init() {
		...
		try {
            ...
            if (logFileType == "Station") {
            	FileHandler chargingStationFileHandler = new FileHandler("charging-station.log", fileSizeLimit, fileCount, true);
            ...
            if (logFileType == "EnergySource") {
            	FileHandler energySourceFileHandler = new FileHandler("energy-source.log", fileSizeLimit, fileCount, true);
